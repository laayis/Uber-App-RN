...
export const searchPlaces = (coordinates, searchTerm) => (dispatch) => {
  ...
  return fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${coordinates.latitude},${coordinates.longitude}&keyword=${searchTerm}&rankby=distance&key=AIzaSyD3n8qUcselZ51NpInnfOcS0Mb1qAmZAfo`)
    .then(res => res.json())
    .then(res => {
